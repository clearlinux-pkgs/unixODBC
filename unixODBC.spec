...
Source0  : http://www.unixodbc.org/unixODBC-2.3.9.tar.gz
...
%prep
%setup -q -n unixODBC-2.3.9
cd %{_builddir}/unixODBC-2.3.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622850184
...
cp %{_builddir}/unixODBC-2.3.9/COPYING %{buildroot}/usr/share/package-licenses/unixODBC/a4e796952ca80385ca199ae5a9d4b43ca63d81d2
cp %{_builddir}/unixODBC-2.3.9/exe/COPYING %{buildroot}/usr/share/package-licenses/unixODBC/41f867b9ac89aebe3dfc7fd10fe97bde3663030d
cp %{_builddir}/unixODBC-2.3.9/libltdl/COPYING.LIB %{buildroot}/usr/share/package-licenses/unixODBC/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
